...
ODDS_API_KEY = os.getenv("ODDS_API_KEY") or "YOUR_KEY"
DAYS_AHEAD = 3
REFRESH_INTERVAL = 15
...
# --------------------------------------------------
# 🧠 SIMPLE MODEL (PLUG YOUR REAL ONE HERE)
# --------------------------------------------------
...
def build_games():
    ...
    for date, games in schedule.items():
        ...
        for key, g in games.items():
            ...
            market = odds_map.get(key1) or odds_map.get(key2)
